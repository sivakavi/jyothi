...
@section('content')
    ...
    <div class="row margin-top-30">
        <div class="col-md-8 center-margin">
            <form class="form-horizontal form-label-left" action="{{ route('hr.employeeReassignStore') }}" method="POST">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content margin-top-40">
                                    ...
                                    <div class="well well-sm margin-top-50">
                                        ...
                                        <a class="btn btn-link pull-right" href="{{ route('hr.employeeReassignList') }}"><i class="glyphicon glyphicon-backward"></i> Back</a>
                                    </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $( "#department_id" ).change(function() {
                ...
                var ajaxUrl = "{{ route('hr.getStatus') }}";
                $.ajax({
                    url: ajaxUrl,
                    type: 'GET',
                    data: {
                ...
                var ajaxUrl = "{{ route('hr.getWorkType') }}";
                $.ajax({
                    url: ajaxUrl,
                    type: 'GET',
                    data: {
