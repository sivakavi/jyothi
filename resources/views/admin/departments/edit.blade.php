...
@section('title', 'Department Update Form')

@section('content')
    <div class="page-header clearfix">
        {{-- <h1><i class="glyphicon glyphicon-edit"></i> departments / Edit #{{$department->id}}</h1> --}}
    </div>
    @include('error')
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content margin-top-40">
                                <div class="form-group @if($errors->has('name')) has-error @endif">
                                    ...
                                    <input type="text" id="name-field" name="name" class="form-control" value="{{ is_null(old("name")) ? $department->name : old("name") }}"/>
                                    @if($errors->has("name"))
