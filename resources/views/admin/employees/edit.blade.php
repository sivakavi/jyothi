                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="form-group @if($errors->has('title')) has-error @endif">
                                ...
                                <input type="text" id="title" name="title" class="form-control" value="{{ $employee->title }}"/>
                                @if($errors->has("title"))
                            ...
                            <div class="form-group @if($errors->has('marital_status')) has-error @endif">
                                ...
                                <input type="text" id="marital_status" name="marital_status" class="form-control" value="{{ $employee->marital_status }}"/>
                            ...
                            <div class="form-group @if($errors->has('position_desc')) has-error @endif">
                                ...
                                <input type="text" id="position_desc" name="position_desc" class="form-control" value="{{ $employee->position_desc }}"/>
                            ...
                            <div class="form-group @if($errors->has('perm_address')) has-error @endif">
                                ...
                                <input type="text" id="perm_address" name="perm_address" class="form-control" value="{{ $employee->perm_address }}"/>
                            ...
                            <div class="form-group @if($errors->has('perm_city')) has-error @endif">
                                ...
                                <input type="text" id="perm_city" name="perm_city" class="form-control" value="{{ $employee->perm_city }}"/>
                            ...
                            <div class="form-group @if($errors->has('perm_district')) has-error @endif">
                                ...
                                <input type="text" id="perm_district" name="perm_district" class="form-control" value="{{ $employee->perm_district }}"/>
                            ...
                            <div class="form-group @if($errors->has('perm_state')) has-error @endif">
                                ...
                                <input type="text" id="perm_state" name="perm_state" class="form-control" value="{{ $employee->perm_state }}"/>
                            ...
                            <div class="form-group @if($errors->has('perm_country')) has-error @endif">
                                ...
                                <input type="text" id="perm_country" name="perm_country" class="form-control" value="{{ $employee->perm_country }}"/>
                            ...
                            <div class="form-group @if($errors->has('perm_pincode')) has-error @endif">
                                ...
                                <input type="text" id="perm_pincode" name="perm_pincode" class="form-control" value="{{ $employee->perm_pincode }}"/>
                            ...
                            <div class="form-group @if($errors->has('present_address')) has-error @endif">
                                ...
                                <input type="text" id="present_address" name="present_address" class="form-control" value="{{ $employee->present_address }}"/>
                            ...
                            <div class="form-group @if($errors->has('present_city')) has-error @endif">
                                ...
                                <input type="text" id="present_city" name="present_city" class="form-control" value="{{ $employee->present_city }}"/>
                            ...
                            <div class="form-group @if($errors->has('present_district')) has-error @endif">
                                ...
                                <input type="text" id="present_district" name="present_district" class="form-control" value="{{ $employee->present_district }}"/>
                            ...
                            <div class="form-group @if($errors->has('present_state')) has-error @endif">
                                ...
                                <input type="text" id="present_state" name="present_state" class="form-control" value="{{ $employee->present_state }}"/>
                            ...
                            <div class="form-group @if($errors->has('present_country')) has-error @endif">
                                ...
                                <input type="text" id="present_country" name="present_country" class="form-control" value="{{ $employee->present_country }}"/>
                            ...
                            <div class="form-group @if($errors->has('present_pincode')) has-error @endif">
                                ...
                                <input type="text" id="present_pincode" name="present_pincode" class="form-control" value="{{ $employee->present_pincode }}"/>
                            ...
                            <div class="form-group @if($errors->has('official_email')) has-error @endif">
                                ...
                                <input type="text" id="official_email" name="official_email" class="form-control" value="{{ $employee->official_email }}"/>
                            ...
                            <div class="form-group @if($errors->has('personal_mobile_no')) has-error @endif">
                                ...
                                <input type="text" id="personal_mobile_no" name="personal_mobile_no" class="form-control" value="{{ $employee->personal_mobile_no }}"/>
                            ...
                            <div class="form-group @if($errors->has('personal_email_id')) has-error @endif">
                                ...
                                <input type="text" id="personal_email_id" name="personal_email_id" class="form-control" value="{{ $employee->personal_email_id }}"/>
                            ...
                            <div class="form-group @if($errors->has('doj')) has-error @endif">
                                ...
                                <input type="date" id="doj" name="doj" class="form-control" value="{{ $employee->doj }}"/>
                                @if($errors->has("doj"))
                            ...
                            <div class="form-group @if($errors->has('doc')) has-error @endif">
                                ...
                                <input type="date" id="doc" name="doc" class="form-control" value="{{ $employee->doc }}"/>
                                @if($errors->has("doc"))
                            ...
                            <div class="form-group @if($errors->has('pan_no')) has-error @endif">
                                ...
                                <input type="text" id="pan_no" name="pan_no" class="form-control" value="{{ $employee->pan_no }}"/>
                            ...
                            <div class="form-group @if($errors->has('aadhar_no')) has-error @endif">
                                ...
                                <input type="text" id="aadhar_no" name="aadhar_no" class="form-control" value="{{ $employee->aadhar_no }}"/>
                            ...
                            <div class="form-group @if($errors->has('pf_no')) has-error @endif">
                                ...
                                <input type="text" id="pf_no" name="pf_no" class="form-control" value="{{ $employee->pf_no }}"/>
                                @if($errors->has("pf_no"))
                            ...
                            <div class="form-group @if($errors->has('uan_no')) has-error @endif">
                                ...
                                <input type="text" id="uan_no" name="uan_no" class="form-control" value="{{ $employee->uan_no }}"/>
                            ...
                            <div class="form-group @if($errors->has('esic_no')) has-error @endif">
                                ...
                                <input type="text" id="esic_no" name="esic_no" class="form-control" value="{{ $employee->esic_no }}"/>
                            ...
                            <div class="form-group @if($errors->has('spouse_name')) has-error @endif">
                                ...
                                <input type="text" id="spouse_name" name="spouse_name" class="form-control" value="{{ $employee->spouse_name }}"/>
                            ...
                            <div class="form-group @if($errors->has('spouse_dob')) has-error @endif">
                                ...
                                <input type="date" id="spouse_dob" name="spouse_dob" class="form-control" value="{{ $employee->spouse_dob }}"/>
                            ...
                            <div class="form-group @if($errors->has('father_name')) has-error @endif">
                                ...
                                <input type="text" id="father_name" name="father_name" class="form-control" value="{{ $employee->father_name }}"/>
                            ...
                            <div class="form-group @if($errors->has('father_dob')) has-error @endif">
                                ...
                                <input type="date" id="father_dob" name="father_dob" class="form-control" value="{{ $employee->father_dob }}"/>
                            ...
                            <div class="form-group @if($errors->has('mother_name')) has-error @endif">
                                ...
                                <input type="text" id="mother_name" name="mother_name" class="form-control" value="{{ $employee->mother_name }}"/>
                            ...
                            <div class="form-group @if($errors->has('mother_dob')) has-error @endif">
                                ...
                                <input type="date" id="mother_dob" name="mother_dob" class="form-control" value="{{ $employee->mother_dob }}"/>
                            ...
                            <div class="form-group @if($errors->has('child1_name')) has-error @endif">
                                ...
                                <input type="text" id="child1_name" name="child1_name" class="form-control" value="{{ $employee->child1_name }}"/>
                            ...
                            <div class="form-group @if($errors->has('child1_dob')) has-error @endif">
                                ...
                                <input type="date" id="child1_dob" name="child1_dob" class="form-control" value="{{ $employee->child1_dob }}"/>
                            ...
                            <div class="form-group @if($errors->has('child2_name')) has-error @endif">
                                ...
                                <input type="text" id="child2_name" name="child2_name" class="form-control" value="{{ $employee->child2_name }}"/>
                            ...
                            <div class="form-group @if($errors->has('child2_dob')) has-error @endif">
                                ...
                                <input type="date" id="child2_dob" name="child2_dob" class="form-control" value="{{ $employee->child2_dob }}"/>
                            ...
                            <div class="form-group @if($errors->has('reporting_manager')) has-error @endif">
                                ...
                                <input type="text" id="reporting_manager" name="reporting_manager" class="form-control" value="{{ $employee->reporting_manager}}"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input id="remark" type="radio" name="remark" value="active" @if($employee->remark == "active") {{'checked'}} @endif> <label for="remark">Active</label>
                                    <input id="remark" type="radio" name="remark" value="inactive"  @if($employee->remark == "inactive") {{'checked'}} @endif> <label for="remark">InActive</label>
                                </div>
                            </div>
