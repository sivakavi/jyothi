...
@section('title', 'Shift Create Form')
   ...
   <div class="page-header clearfix"></div>
    ...
    <div class="row margin-top-30">
        <div class="col-md-8 center-margin">
            <form class="form-horizontal form-label-left" action="{{ route('admin.shifts.store') }}" method="POST">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content margin-top-40">
                                    ...
                                    <div class="form-group @if($errors->has('allias')) has-error @endif">
                                        ...
                                        <input type="text" id="allias" name="allias" class="form-control" value="{{ old("allias") }}"/>
                                    ...
                                    <div class="form-group @if($errors->has('in')) has-error @endif">
                                        ...
                                        <input type="time" id="in" name="in" class="form-control" value="{{ old("in") }}"/>
                                        @if($errors->has("in"))
                                    ...
                                    <div class="form-group @if($errors->has('out')) has-error @endif">
                                        ...
                                        <input type="time" id="out" name="out" class="form-control" value="{{ old("out") }}"/>
                                        @if($errors->has("out"))
                                    ...
                                    <div class="well well-sm margin-top-50">
                                        <button type="submit" class="btn btn-primary btn-round btn-sm">Create Shift</button>
