...
<div class="page-header clearfix"></div>
    <div class="row margin-top-30">
        <div class="col-md-8 col-sm-12 col-xs-12 center-margin">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>{{$shift->name}} <small>Details</small></h2>
    ...
    <a class="btn btn-link" href="{{ route('admin.shifts.index') }}"><i class="glyphicon glyphicon-backward"></i>  Back</a>
@endsection