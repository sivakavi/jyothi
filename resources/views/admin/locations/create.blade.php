   ...
   <div class="page-header clearfix"></div>
    ...
    <div class="row margin-top-30">
        <div class="col-md-8 center-margin">
            <form class="form-horizontal form-label-left" action="{{ route('admin.locations.store') }}" method="POST">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content margin-top-40">
                                    ...
                                    <div class="well well-sm margin-top-50">
                                        <button type="submit" class="btn btn-primary btn-round btn-sm">Create Location</button>
